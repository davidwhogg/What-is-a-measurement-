...
You can often (but not always) think of the LF as a prediction for the expectation of the data plus a noise model.
...
The LF both tells you how you expect the data to change as you change the parameters, \emph{and} how precisely the data can be predicted, given the parameters.
...
Reparameterization-invariance of the LF.
...
Does the requirement that there be a peak in a sensible likelihood function (LF) imply that we can only determine whether or not we have a measurement by directly looking at the likelihood function?
