...
However even the Bayesians have to decide what number (or numbers or intervals) they \emph{report in the abstract of their paper} or in their summary slides about their parameter of interest $\theta$ (I say more about this in \ref{sec:claim}).
...
This all might have sounded extremely frequentist, because it is so focused on the likelihood, and not on priors and posteriors.
It is not!
