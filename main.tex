...
HOGG: Meanings of differences in log likelihood.
A large difference in log likelihood is required to claim a measurement.

HOGG: Reparameterization-invariance of the likelihood function.
This invariance does not hold for any other part of statistical inference, as we will see.

\section{Nuisance parameters}

Much of what follows is about the nuisance parameters $\alpha$.
...
That's true even when those priors on the nuisances are flat, as we show in \secref{sec:flat}.
