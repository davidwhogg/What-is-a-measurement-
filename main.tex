...
\section{What is my data?\protect\footnote{I often get asked whether ``data'' is a plural noun or singular. My position is that ``data'' is a \emph{mass noun} like ``grass'' or ``hair.'' I have attempted to use it this way throughout this \documentname, but I might not be perfectly consistent.}}\label{sec:data}
