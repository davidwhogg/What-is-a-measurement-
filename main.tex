...
HOGG: The impossibility of combining posteriors unless they are continuous functions.
...
I have taken the view recently that the decisions and assumptions should make up a stand-alone section in the papers I write (see, for example, \cite{}).
